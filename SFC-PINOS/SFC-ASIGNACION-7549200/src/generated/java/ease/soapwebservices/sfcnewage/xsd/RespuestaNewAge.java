...
package ease.soapwebservices.sfcnewage.xsd;
...
@XmlType(name = "RespuestaNewAge", namespace = "http://sfcnewage.soapwebservices.ease/xsd/creacion", propOrder = {
    "claveFin",
    "claveInicio",
    "descRetorno",
    "indMasDatos",
