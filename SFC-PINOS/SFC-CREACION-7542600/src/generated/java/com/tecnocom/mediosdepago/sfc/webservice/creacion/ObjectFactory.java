...
public class ObjectFactory {
    ...
    /**
     * Create an instance of {@link ExceptionException }
     * 
     */
    public ExceptionException createExceptionException() {
        return new ExceptionException();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ExceptionException }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ExceptionException }{@code >}
     */
    @XmlElementDecl(namespace = "http://webservice.sfc.mediosdepago.tecnocom.com", name = "Exception", scope = Exception.class)
    public JAXBElement<ExceptionException> createExceptionException(ExceptionException value) {
        return new JAXBElement<ExceptionException>(_ExceptionException_QNAME, ExceptionException.class, Exception.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link PeticionP7542600WS }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link PeticionP7542600WS }{@code >}
     */
    @XmlElementDecl(namespace = "http://webservice.sfc.mediosdepago.tecnocom.com", name = "msgEnvio", scope = RunService.class)
    public JAXBElement<PeticionP7542600WS> createRunServiceMsgEnvio(PeticionP7542600WS value) {
        return new JAXBElement<PeticionP7542600WS>(_RunServiceMsgEnvio_QNAME, PeticionP7542600WS.class, RunService.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RespuestaP7542600WS }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link RespuestaP7542600WS }{@code >}
     */
    @XmlElementDecl(namespace = "http://webservice.sfc.mediosdepago.tecnocom.com", name = "return", scope = RunServiceResponse.class)
    public JAXBElement<RespuestaP7542600WS> createRunServiceResponseReturn(RespuestaP7542600WS value) {
        return new JAXBElement<RespuestaP7542600WS>(_RunServiceResponseReturn_QNAME, RespuestaP7542600WS.class, RunServiceResponse.class, value);
    }
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.sfc.mediosdepago.tecnocom.com", name = "Exception", scope = ExceptionException.class)
    public JAXBElement<Object> createExceptionExceptionException(Object value) {
        return new JAXBElement<Object>(_ExceptionException_QNAME, Object.class, ExceptionException.class, value);
    }
